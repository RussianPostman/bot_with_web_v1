...
from handlers.google_tools import get_free_events, Event, get_users_booking
...
def admin_notification_handler(data: dict) -> str:
...
def event_hour_handler(event_str: str) -> str:
